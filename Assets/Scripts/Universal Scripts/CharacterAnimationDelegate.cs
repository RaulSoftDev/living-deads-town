...
public class CharacterAnimationDelegate : MonoBehaviour {
    ...
    IEnumerator StandUpAfterTime() {
        ...
        enemy_Movement.myBody.isKinematic = false;
        enemy_Movement.myCollision.isTrigger = false;
    }
    ...
    void Enemy_KnockedDown() {
        ...
        audioSource.Play();
        enemy_Movement.myBody.isKinematic = true;
        enemy_Movement.myCollision.isTrigger = true;
    }
