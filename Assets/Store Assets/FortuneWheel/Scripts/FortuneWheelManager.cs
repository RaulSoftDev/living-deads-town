...
public class FortuneWheelManager : MonoBehaviour
{
    ...
    public GameObject fortuneWheelObject;   // Main gameobject
    ...
    private IEnumerator CloseWheel()
    {
        ...
        wheelDone = true;
        GameObject.Find("EventManager").GetComponent<EventManager>().roundEnds = true;
        GameObject.Find("FadeEffects").GetComponent<Animator>().SetTrigger("RoundFinish");
    }
}
